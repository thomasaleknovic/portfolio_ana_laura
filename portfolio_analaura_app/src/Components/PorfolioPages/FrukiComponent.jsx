    ...
    return(
        ...
        <div>
            ...
            <div className='bg-white flex flex-col items-center text-gray-600 md:text-lg sm:text-base h-full pt-20'>
                ...
                <p className='w-2/4 mt-5 mb-10 text-center'>{projectData.projects[0].description}</p>
                <div className='flex flex-row flex-wrap justify-center mt-10 p-4'>
                ...
                <div className='flex flex-row flex-wrap justify-center mt-10 p-4'>
                    ...
                    return(
                        <img src={photo} alt='' height={220} width={220} className='mr-4 mt-4shadow-lg rounded-lg'/>
                        )})
                    }
                </div>
