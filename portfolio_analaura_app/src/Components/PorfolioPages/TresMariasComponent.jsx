    ...
    return(
        ...
        <div>
            ...
            <div className='bg-white flex flex-col items-center text-gray-600 md:text-lg sm:text-base h-full pt-20'>
                ...
                <a href='https://www.instagram.com/tv/COp5lUZA1sU/?igshid=YmMyMTA2M2Y=' target="_blank" className='relative grid overflow-hidden mb-10 mr-10 rounded-lg cursor-pointer shadow-xl'>
                ...
                <div className='flex justify-center'>
                    ...
                    <div className='overflow-hidden mb-10 mr-10 rounded-lg shadow-xl'>
